  ...
  var bullseyeLocator = (function ($) {
    ...
    var searchRadius = '150'; //Can be any number
    var mapIconSrc = ''; // Enter the directory path to where 'map-icon.png' and 'ajax-loader.gif' are uploaded on your server. e.g.: 'http://example.com/images/'
    var locatorHeadingText = 'FIND YOUR NEAREST LOCATION'; // Change the heading text that appears at the top of the widget.
                                    ...
                                    $.getJSON(wsurl + "&callback=ResultList", function (data) { })
                                        ...
                                        .done(function (data) {
                                            if (data.ResultList.length > 0) {
                                                ...
                                                window.imgLink = data.ResultList[0].ImageFileUrl != null ? data.ResultList[0].ImageFileUrl : "";
